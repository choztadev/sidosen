  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($menu == "departemen") echo "class='active' "  ?>><a href="<?php echo base_url()?>departemen"><i class="fa fa-link"></i> <span>Departemen</span></a></li>
        <li <?php if($menu == "dosen") echo "class='active' "  ?>><a href="<?php echo base_url()?>dosen"><i class="fa fa-link"></i> <span>Dosen</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
